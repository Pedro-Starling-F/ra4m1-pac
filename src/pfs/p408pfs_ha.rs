...
impl W {
    #[doc = "Bit 0 - Port Output Data"]
    #[inline(always)]
    pub fn podr(&mut self) -> PodrW<'_, P408pfsHaSpec> {
        PodrW::new(self, 0)
    }
    #[doc = "Bit 2 - Port Direction"]
    #[inline(always)]
    pub fn pdr(&mut self) -> PdrW<'_, P408pfsHaSpec> {
        PdrW::new(self, 2)
    }
    #[doc = "Bit 4 - Pull-up Control"]
    #[inline(always)]
    pub fn pcr(&mut self) -> PcrW<'_, P408pfsHaSpec> {
        PcrW::new(self, 4)
    }
    #[doc = "Bit 6 - N-Channel Open Drain Control"]
    #[inline(always)]
    pub fn ncodr(&mut self) -> NcodrW<'_, P408pfsHaSpec> {
        NcodrW::new(self, 6)
    }
    #[doc = "Bit 10 - Drive Strength Control Register"]
    #[inline(always)]
    pub fn dscr(&mut self) -> DscrW<'_, P408pfsHaSpec> {
        DscrW::new(self, 10)
    }
    #[doc = "Bit 11 - Drive Strength Control Register"]
    #[inline(always)]
    pub fn dscr1(&mut self) -> Dscr1W<'_, P408pfsHaSpec> {
        Dscr1W::new(self, 11)
    }
    #[doc = "Bit 12 - Event on Rising"]
    #[inline(always)]
    pub fn eor(&mut self) -> EorW<'_, P408pfsHaSpec> {
        EorW::new(self, 12)
    }
    #[doc = "Bit 13 - Event on Falling"]
    #[inline(always)]
    pub fn eof(&mut self) -> EofW<'_, P408pfsHaSpec> {
        EofW::new(self, 13)
    }
    #[doc = "Bit 14 - IRQ input enable"]
    #[inline(always)]
    pub fn isel(&mut self) -> IselW<'_, P408pfsHaSpec> {
        IselW::new(self, 14)
    }
    #[doc = "Bit 15 - Analog Input enable"]
    #[inline(always)]
    pub fn asel(&mut self) -> AselW<'_, P408pfsHaSpec> {
        AselW::new(self, 15)
    }
}
