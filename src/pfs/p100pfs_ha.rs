#[doc = "Register `P100PFS_HA` reader"]
pub type R = crate::R<P100pfsHaSpec>;
#[doc = "Register `P100PFS_HA` writer"]
pub type W = crate::W<P100pfsHaSpec>;
...
impl W {
    #[doc = "Bit 0 - Port Output Data"]
    #[inline(always)]
    pub fn podr(&mut self) -> PodrW<'_, P100pfsHaSpec> {
        PodrW::new(self, 0)
    }
    #[doc = "Bit 2 - Port Direction"]
    #[inline(always)]
    pub fn pdr(&mut self) -> PdrW<'_, P100pfsHaSpec> {
        PdrW::new(self, 2)
    }
    #[doc = "Bit 4 - Pull-up Control"]
    #[inline(always)]
    pub fn pcr(&mut self) -> PcrW<'_, P100pfsHaSpec> {
        PcrW::new(self, 4)
    }
    #[doc = "Bit 6 - N-Channel Open Drain Control"]
    #[inline(always)]
    pub fn ncodr(&mut self) -> NcodrW<'_, P100pfsHaSpec> {
        NcodrW::new(self, 6)
    }
    #[doc = "Bit 10 - Port Drive Capability"]
    #[inline(always)]
    pub fn dscr(&mut self) -> DscrW<'_, P100pfsHaSpec> {
        DscrW::new(self, 10)
    }
    #[doc = "Bit 12 - Event on Rising"]
    #[inline(always)]
    pub fn eor(&mut self) -> EorW<'_, P100pfsHaSpec> {
        EorW::new(self, 12)
    }
    #[doc = "Bit 13 - Event on Falling"]
    #[inline(always)]
    pub fn eof(&mut self) -> EofW<'_, P100pfsHaSpec> {
        EofW::new(self, 13)
    }
    #[doc = "Bit 14 - IRQ input enable"]
    #[inline(always)]
    pub fn isel(&mut self) -> IselW<'_, P100pfsHaSpec> {
        IselW::new(self, 14)
    }
    #[doc = "Bit 15 - Analog Input enable"]
    #[inline(always)]
    pub fn asel(&mut self) -> AselW<'_, P100pfsHaSpec> {
        AselW::new(self, 15)
    }
}
#[doc = "P100 Pin Function Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`p100pfs_ha::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p100pfs_ha::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P100pfsHaSpec;
impl crate::RegisterSpec for P100pfsHaSpec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`p100pfs_ha::R`](R) reader structure"]
impl crate::Readable for P100pfsHaSpec {}
#[doc = "`write(|w| ..)` method takes [`p100pfs_ha::W`](W) writer structure"]
impl crate::Writable for P100pfsHaSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P100PFS_HA to value 0"]
impl crate::Resettable for P100pfsHaSpec {}
