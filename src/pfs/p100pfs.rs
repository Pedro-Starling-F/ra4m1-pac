#[doc = "Register `P100PFS` reader"]
pub type R = crate::R<P100pfsSpec>;
#[doc = "Register `P100PFS` writer"]
pub type W = crate::W<P100pfsSpec>;
...
impl W {
    #[doc = "Bit 0 - Port Output Data"]
    #[inline(always)]
    pub fn podr(&mut self) -> PodrW<'_, P100pfsSpec> {
        PodrW::new(self, 0)
    }
    #[doc = "Bit 2 - Port Direction"]
    #[inline(always)]
    pub fn pdr(&mut self) -> PdrW<'_, P100pfsSpec> {
        PdrW::new(self, 2)
    }
    #[doc = "Bit 4 - Pull-up Control"]
    #[inline(always)]
    pub fn pcr(&mut self) -> PcrW<'_, P100pfsSpec> {
        PcrW::new(self, 4)
    }
    #[doc = "Bit 6 - N-Channel Open Drain Control"]
    #[inline(always)]
    pub fn ncodr(&mut self) -> NcodrW<'_, P100pfsSpec> {
        NcodrW::new(self, 6)
    }
    #[doc = "Bit 10 - Port Drive Capability"]
    #[inline(always)]
    pub fn dscr(&mut self) -> DscrW<'_, P100pfsSpec> {
        DscrW::new(self, 10)
    }
    #[doc = "Bit 12 - Event on Rising"]
    #[inline(always)]
    pub fn eor(&mut self) -> EorW<'_, P100pfsSpec> {
        EorW::new(self, 12)
    }
    #[doc = "Bit 13 - Event on Falling"]
    #[inline(always)]
    pub fn eof(&mut self) -> EofW<'_, P100pfsSpec> {
        EofW::new(self, 13)
    }
    #[doc = "Bit 14 - IRQ input enable"]
    #[inline(always)]
    pub fn isel(&mut self) -> IselW<'_, P100pfsSpec> {
        IselW::new(self, 14)
    }
    #[doc = "Bit 15 - Analog Input enable"]
    #[inline(always)]
    pub fn asel(&mut self) -> AselW<'_, P100pfsSpec> {
        AselW::new(self, 15)
    }
    #[doc = "Bit 16 - Port Mode Control"]
    #[inline(always)]
    pub fn pmr(&mut self) -> PmrW<'_, P100pfsSpec> {
        PmrW::new(self, 16)
    }
    #[doc = "Bits 24:28 - Port Function Select These bits select the peripheral function. For individual pin functions, see the MPC table"]
    #[inline(always)]
    pub fn psel(&mut self) -> PselW<'_, P100pfsSpec> {
        PselW::new(self, 24)
    }
}
#[doc = "P100 Pin Function Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`p100pfs::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`p100pfs::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct P100pfsSpec;
impl crate::RegisterSpec for P100pfsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`p100pfs::R`](R) reader structure"]
impl crate::Readable for P100pfsSpec {}
#[doc = "`write(|w| ..)` method takes [`p100pfs::W`](W) writer structure"]
impl crate::Writable for P100pfsSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets P100PFS to value 0"]
impl crate::Resettable for P100pfsSpec {}
