...
impl W {
    #[doc = "Bits 0:3 - FIFO Port Access Pipe Specification"]
    #[inline(always)]
    pub fn curpipe(&mut self) -> CurpipeW<'_, D1fifoselSpec> {
        CurpipeW::new(self, 0)
    }
    #[doc = "Bit 8 - FIFO Port Endian Control"]
    #[inline(always)]
    pub fn bigend(&mut self) -> BigendW<'_, D1fifoselSpec> {
        BigendW::new(self, 8)
    }
    #[doc = "Bit 10 - FIFO Port Access Bit Width"]
    #[inline(always)]
    pub fn mbw(&mut self) -> MbwW<'_, D1fifoselSpec> {
        MbwW::new(self, 10)
    }
    #[doc = "Bit 12 - DMA/DTC Transfer Request Enable"]
    #[inline(always)]
    pub fn dreqe(&mut self) -> DreqeW<'_, D1fifoselSpec> {
        DreqeW::new(self, 12)
    }
    #[doc = "Bit 13 - Auto Buffer Memory Clear Mode Accessed after Specified Pipe Data is Read"]
    #[inline(always)]
    pub fn dclrm(&mut self) -> DclrmW<'_, D1fifoselSpec> {
        DclrmW::new(self, 13)
    }
    #[doc = "Bit 14 - Buffer Pointer Rewind"]
    #[inline(always)]
    pub fn rew(&mut self) -> RewW<'_, D1fifoselSpec> {
        RewW::new(self, 14)
    }
    #[doc = "Bit 15 - Read Count Mode"]
    #[inline(always)]
    pub fn rcnt(&mut self) -> RcntW<'_, D1fifoselSpec> {
        RcntW::new(self, 15)
    }
}
