...
impl W {
    #[doc = "Bit 0 - Multi-Processor Bit Transfer This bit should be 0 in smart card interface mode."]
    #[inline(always)]
    pub fn mpbt(&mut self) -> MpbtW<'_, SsrSmciSpec> {
        MpbtW::new(self, 0)
    }
    #[doc = "Bit 3 - Parity Error Flag"]
    #[inline(always)]
    pub fn per(&mut self) -> PerW<'_, SsrSmciSpec> {
        PerW::new(self, 3)
    }
    #[doc = "Bit 4 - Error Signal Status Flag"]
    #[inline(always)]
    pub fn ers(&mut self) -> ErsW<'_, SsrSmciSpec> {
        ErsW::new(self, 4)
    }
    #[doc = "Bit 5 - Overrun Error Flag"]
    #[inline(always)]
    pub fn orer(&mut self) -> OrerW<'_, SsrSmciSpec> {
        OrerW::new(self, 5)
    }
    #[doc = "Bit 6 - Receive Data Full Flag"]
    #[inline(always)]
    pub fn rdrf(&mut self) -> RdrfW<'_, SsrSmciSpec> {
        RdrfW::new(self, 6)
    }
    #[doc = "Bit 7 - Transmit Data Empty Flag"]
    #[inline(always)]
    pub fn tdre(&mut self) -> TdreW<'_, SsrSmciSpec> {
        TdreW::new(self, 7)
    }
}
