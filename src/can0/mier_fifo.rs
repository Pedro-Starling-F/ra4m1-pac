...
impl W {
    #[doc = "Bit 0 - mailbox 0 Interrupt Enable"]
    #[inline(always)]
    pub fn mb0(&mut self) -> Mb0W<'_, MierFifoSpec> {
        Mb0W::new(self, 0)
    }
    #[doc = "Bit 1 - mailbox 1 Interrupt Enable"]
    #[inline(always)]
    pub fn mb1(&mut self) -> Mb1W<'_, MierFifoSpec> {
        Mb1W::new(self, 1)
    }
    #[doc = "Bit 2 - mailbox 2 Interrupt Enable"]
    #[inline(always)]
    pub fn mb2(&mut self) -> Mb2W<'_, MierFifoSpec> {
        Mb2W::new(self, 2)
    }
    #[doc = "Bit 3 - mailbox 3 Interrupt Enable"]
    #[inline(always)]
    pub fn mb3(&mut self) -> Mb3W<'_, MierFifoSpec> {
        Mb3W::new(self, 3)
    }
    #[doc = "Bit 4 - mailbox 4 Interrupt Enable"]
    #[inline(always)]
    pub fn mb4(&mut self) -> Mb4W<'_, MierFifoSpec> {
        Mb4W::new(self, 4)
    }
    #[doc = "Bit 5 - mailbox 5 Interrupt Enable"]
    #[inline(always)]
    pub fn mb5(&mut self) -> Mb5W<'_, MierFifoSpec> {
        Mb5W::new(self, 5)
    }
    #[doc = "Bit 6 - mailbox 6 Interrupt Enable"]
    #[inline(always)]
    pub fn mb6(&mut self) -> Mb6W<'_, MierFifoSpec> {
        Mb6W::new(self, 6)
    }
    #[doc = "Bit 7 - mailbox 7 Interrupt Enable"]
    #[inline(always)]
    pub fn mb7(&mut self) -> Mb7W<'_, MierFifoSpec> {
        Mb7W::new(self, 7)
    }
    #[doc = "Bit 8 - mailbox 8 Interrupt Enable"]
    #[inline(always)]
    pub fn mb8(&mut self) -> Mb8W<'_, MierFifoSpec> {
        Mb8W::new(self, 8)
    }
    #[doc = "Bit 9 - mailbox 9 Interrupt Enable"]
    #[inline(always)]
    pub fn mb9(&mut self) -> Mb9W<'_, MierFifoSpec> {
        Mb9W::new(self, 9)
    }
    #[doc = "Bit 10 - mailbox 10 Interrupt Enable"]
    #[inline(always)]
    pub fn mb10(&mut self) -> Mb10W<'_, MierFifoSpec> {
        Mb10W::new(self, 10)
    }
    #[doc = "Bit 11 - mailbox 11 Interrupt Enable"]
    #[inline(always)]
    pub fn mb11(&mut self) -> Mb11W<'_, MierFifoSpec> {
        Mb11W::new(self, 11)
    }
    #[doc = "Bit 12 - mailbox 12 Interrupt Enable"]
    #[inline(always)]
    pub fn mb12(&mut self) -> Mb12W<'_, MierFifoSpec> {
        Mb12W::new(self, 12)
    }
    #[doc = "Bit 13 - mailbox 13 Interrupt Enable"]
    #[inline(always)]
    pub fn mb13(&mut self) -> Mb13W<'_, MierFifoSpec> {
        Mb13W::new(self, 13)
    }
    #[doc = "Bit 14 - mailbox 14 Interrupt Enable"]
    #[inline(always)]
    pub fn mb14(&mut self) -> Mb14W<'_, MierFifoSpec> {
        Mb14W::new(self, 14)
    }
    #[doc = "Bit 15 - mailbox 15 Interrupt Enable"]
    #[inline(always)]
    pub fn mb15(&mut self) -> Mb15W<'_, MierFifoSpec> {
        Mb15W::new(self, 15)
    }
    #[doc = "Bit 16 - mailbox 16 Interrupt Enable"]
    #[inline(always)]
    pub fn mb16(&mut self) -> Mb16W<'_, MierFifoSpec> {
        Mb16W::new(self, 16)
    }
    #[doc = "Bit 17 - mailbox 17 Interrupt Enable"]
    #[inline(always)]
    pub fn mb17(&mut self) -> Mb17W<'_, MierFifoSpec> {
        Mb17W::new(self, 17)
    }
    #[doc = "Bit 18 - mailbox 18 Interrupt Enable"]
    #[inline(always)]
    pub fn mb18(&mut self) -> Mb18W<'_, MierFifoSpec> {
        Mb18W::new(self, 18)
    }
    #[doc = "Bit 19 - mailbox 19 Interrupt Enable"]
    #[inline(always)]
    pub fn mb19(&mut self) -> Mb19W<'_, MierFifoSpec> {
        Mb19W::new(self, 19)
    }
    #[doc = "Bit 20 - mailbox 20 Interrupt Enable"]
    #[inline(always)]
    pub fn mb20(&mut self) -> Mb20W<'_, MierFifoSpec> {
        Mb20W::new(self, 20)
    }
    #[doc = "Bit 21 - mailbox 21 Interrupt Enable"]
    #[inline(always)]
    pub fn mb21(&mut self) -> Mb21W<'_, MierFifoSpec> {
        Mb21W::new(self, 21)
    }
    #[doc = "Bit 22 - mailbox 22 Interrupt Enable"]
    #[inline(always)]
    pub fn mb22(&mut self) -> Mb22W<'_, MierFifoSpec> {
        Mb22W::new(self, 22)
    }
    #[doc = "Bit 23 - mailbox 23 Interrupt Enable"]
    #[inline(always)]
    pub fn mb23(&mut self) -> Mb23W<'_, MierFifoSpec> {
        Mb23W::new(self, 23)
    }
    #[doc = "Bit 24 - Transmit FIFO Interrupt Enable"]
    #[inline(always)]
    pub fn mb24(&mut self) -> Mb24W<'_, MierFifoSpec> {
        Mb24W::new(self, 24)
    }
    #[doc = "Bit 25 - Transmit FIFO Interrupt Generation Timing Control"]
    #[inline(always)]
    pub fn mb25(&mut self) -> Mb25W<'_, MierFifoSpec> {
        Mb25W::new(self, 25)
    }
    #[doc = "Bit 28 - Receive FIFO Interrupt Enable"]
    #[inline(always)]
    pub fn mb28(&mut self) -> Mb28W<'_, MierFifoSpec> {
        Mb28W::new(self, 28)
    }
    #[doc = "Bit 29 - Receive FIFO Interrupt Generation Timing Control"]
    #[inline(always)]
    pub fn mb29(&mut self) -> Mb29W<'_, MierFifoSpec> {
        Mb29W::new(self, 29)
    }
}
